package cn.cc.utils.http.crawler.iptools;
 ...
 * 2020/3/3
 */
class ProxyAuthenticator_test extends Authenticator {
    private String user, password;

    public ProxyAuthenticator_test(String user, String password) {
        this.user     = user;
