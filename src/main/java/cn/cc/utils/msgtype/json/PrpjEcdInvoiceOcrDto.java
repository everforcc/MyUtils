...
public class PrpjEcdInvoiceOcrDto implements Serializable{
	...
	private List<PrpjEcdInvoiceOcrDto> prpjecdInvoiceOcrList;
	...
	public List<PrpjEcdInvoiceOcrDto> getPrpjecdInvoiceOcrList() {
		return prpjecdInvoiceOcrList;
	}

	public void setPrpjecdInvoiceOcrList(
			List<PrpjEcdInvoiceOcrDto> prpjecdInvoiceOcrList) {
