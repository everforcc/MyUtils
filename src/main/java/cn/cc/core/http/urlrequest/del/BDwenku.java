...
public class BDwenku {
    public static void main(String[] args) throws Exception {
        ...
        HttpURLConnectionUtil.sendToUrlRequest(url,"POST","",ConstantCharSet.UTF_8);*/


        Document document = Jsoup.parse(new File("F:\\aly\\百度\\计算机调研报告 - 百度文库.html"), ConstantCharSet.UTF_8);
