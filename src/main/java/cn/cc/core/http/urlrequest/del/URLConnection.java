...
public class URLConnection {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String sendMsg="{\"operateType\":\"prepareEdit\",\n" +
                ...
                "\t}\n" +
                "}\n";
        String str = HttpURLConnectionUtil.sendToUrlRequest(urlPath,"POST",sendMsg, ConstantCharSet.UTF_8);
    ...
    public static JSONObject postResponse(String urlPath, String Info) throws Exception{
        String str = HttpURLConnectionUtil.sendToUrlRequest(urlPath,"POST",Info,ConstantCharSet.UTF_8);
