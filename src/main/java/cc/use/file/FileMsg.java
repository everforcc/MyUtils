...
public class FileMsg {
    ...
    public static void main(String[] args) throws IOException {
        File file = new File(ConstantFile.L1_javaFilePath + "\\java\\rename\\ep\\cc00.png");
    ...
    public FileSysMsg saveFileMsg(FileSysMsg fileSysMsg,File file,String path){
         ...
         */
        fileSysMsg.setFileVirtualRoute(path.replaceAll("\\\\","/").replace(ConstantFile.L1_javaFilePath + "",""));
