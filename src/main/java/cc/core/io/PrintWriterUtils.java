...
public class PrintWriterUtils {
    ...
    public static void fileWriter(String filePath,String fileName,String content){

        // 文件名校验
        fileName = FileUtils.checkFileName(fileName);
        filePath = FileUtils.checkFilePath(filePath);

        fileWriter(new File(filePath + File.separator + fileName),content);
    }
    ...
    // FileWriter
    // 单独使用 FileWriter
    public void IO_FileWriter(String filePath, String fileName,String content){
