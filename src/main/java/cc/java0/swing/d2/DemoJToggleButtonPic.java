 ...
 */
public class DemoJToggleButtonPic {
    ...
    public static void main(String[] args) {
        ...
        toggleBtn.setSelectedIcon(new ImageIcon("src/main/resources/pic/toggle_on.png"));
        toggleBtn.setIcon(new ImageIcon("src/main/resources/pic/toggle_off.png"));
