package cc.advanced.web.ftp.apacheftp;
...
public class FtpApacheUtil {
	...
	// 命名服务器20,21都设置了但是20不能用
	private static int port = 21;

	private static Logger logger= LoggerFactory.getLogger(FtpApacheUtil.class);
...
//		System.out.println(isEmpty("a"));
	 ...
	 * 主动模式
	 */
	public static void connectActiveMode(){
